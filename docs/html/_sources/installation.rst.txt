...
`here <https://pypi.org/project/mysqlclient/#files>`__. There is also an unoffical repo of ``.whl`` files `here <https://www.lfd.uci.edu/~gohlke/pythonlibs/#mysqlclient>`__ (recommended source). To install simply run ``pip install name-of-the-whl-file.whl``.
